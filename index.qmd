...
- This indicates that on average, you gain money (making it more than $1,000) from the investment.

### Question 3: Single Simulation (75% Grade)

**Run one simulation showing the dynamics of your account balance over time. Make a plot showing your simulated account balance over time. Comment on the results. Are you happy?**
...
**Answer:** The distribution shows most outcomes being very low (near zero) but with a few extremely high outcomes. The mean is much higher than the median, indicating the distribution is heavily right-skewed. Most simulations result in significant losses, but a few "lucky" paths result in enormous gains. This would not make an investor happy.
...
**Answer:** Based on the 100 simulations, the probability that your account balance will be greater than $1,000 at age 55 is approximately **0.24**. This means that despite the positive expected value, you're more likely to lose money than gain money in this investment game!
...
**Answer:** The modified strategy (betting exactly 50% of current balance each round) shows a **51%** chance of ending above $1,000, and a **4%** chance of ending above $10,000. The probability of ending above $10,000 with the modified strategy is **lower** than the original strategy. This demonstrates how different betting strategies can significantly affect the outcomes of the game.
